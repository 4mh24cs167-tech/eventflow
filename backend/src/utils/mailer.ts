...
/**
 * Send OTP verification email for event registration.
 */
export async function sendOtpEmail(options: {
  ...
  const { recipientEmail, otp, eventTitle } = options;
...
<body style="margin:0;padding:0;background-color:#0f1117;font-family:'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif;">
    ...
    <tr>
      <td align="center">
        <table width="560" cellpadding="0" cellspacing="0" style="background:linear-gradient(135deg,#1a1d2e 0%,#12141f 100%);border-radius:16px;border:1px solid rgba(99,102,241,0.2);overflow:hidden;">
          <tr>
            <td style="padding:32px 40px 24px;border-bottom:1px solid rgba(255,255,255,0.06);">
              <h1 style="margin:0;font-size:24px;font-weight:700;color:#ffffff;letter-spacing:-0.5px;">📋 Event Flow</h1>
              <p style="margin:4px 0 0;font-size:13px;color:#6366f1;font-weight:500;letter-spacing:0.5px;">EMAIL VERIFICATION</p>
            </td>
          </tr>
          <tr>
            <td style="padding:32px 40px;">
              <h2 style="margin:0 0 8px;font-size:20px;color:#e2e8f0;">Verify Your Email</h2>
              <p style="margin:0 0 24px;font-size:14px;color:#94a3b8;line-height:1.6;">
                You're registering for <strong style="color:#818cf8;">${eventTitle}</strong>. Use the OTP below to verify your email address.
              </p>
              
              <table width="100%" cellpadding="0" cellspacing="0" style="background:rgba(99,102,241,0.08);border:1px solid rgba(99,102,241,0.15);border-radius:12px;margin-bottom:24px;">
                <tr>
                  <td align="center" style="padding:32px;">
                    <p style="margin:0 0 8px;font-size:12px;font-weight:600;color:#6366f1;text-transform:uppercase;letter-spacing:1px;">Your OTP Code</p>
                    <p style="margin:0;font-size:36px;font-weight:800;color:#34d399;letter-spacing:8px;font-family:'Courier New',monospace;">${otp}</p>
                  </td>
                </tr>
              </table>
          ...
          <tr>
            <td style="padding:20px 40px;border-top:1px solid rgba(255,255,255,0.06);">
              <p style="margin:0;font-size:12px;color:#475569;text-align:center;">
                This is an automated message from Event Flow. Do not reply to this email.
              </p>
            </td>
          </tr>
        </table>
  ...
  return sendBrevoEmail({
    ...
    subject: `🔐 Your OTP for ${eventTitle} — Event Flow`,
    htmlContent,
  });
}
